...
function App(){
 ...
 const[file,setFile]=useState(null),[preview,setPreview]=useState(""),[playableVideo,setPlayableVideo]=useState(""),[localEngineUrl,setLocalEngineUrl]=useState(()=>["localhost","127.0.0.1"].includes(window.location.hostname)?"http://127.0.0.1:8000":""),[gpuApiKey,setGpuApiKey]=useState(""),[brief,setBrief]=useState("Study the uploaded image and create a coherent short video story based only on the people, objects, setting, and visible text it actually contains. Keep identities, composition, and wording consistent. Show a natural action that could follow from the scene, in a few clear story beats, with believable movement. Do not turn the image into a poster or slideshow.");
